...
import babel
from starter_code.models import db, Artist, Venue, Show
from flask import Flask, render_template, request, Response, flash, redirect, url_for
from flask_moment import Moment
import sys
import logging
from starter_code.forms import ArtistForm, VenueForm, ShowForm
...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql+psycopg2://postgres@localhost:5432/fyyur'
...
def venues():
  ...
  venues = Venue.query.distinct(Venue.state).all()
  data = [venue.order_by_state for venue in venues]
...
def search_venues():
  ...
  response = {
    ...
    "data": [venue.venue_search_details for venue in venue_results]
  }
...
def show_venue(venue_id):
  ...
  data = Venue.query.get(venue_id).view_venue
...
def shows():
  ...
  shows_list = [ show.show_details_list for show in shows]
