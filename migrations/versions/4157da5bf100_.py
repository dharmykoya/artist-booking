...
Revision ID: 4157da5bf100
Revises: a47699d72f88
Create Date: 2019-10-07 11:06:59.525352
...
revision = '4157da5bf100'
down_revision = 'a47699d72f88'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('facebook', sa.VARCHAR(length=120), autoincrement=False, nullable=True),
